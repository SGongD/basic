...
<div class="form-group">
    ...
    <div class="col-sm-8">
        <select name="business" id="business" class="form-control input-s-sm inline">
...
<div class="form-group">
    ...
    <div class="col-sm-8">
        <select name="organizeId" class="form-control input-s-sm inline" id="organizeId" data-toggle-name="#jiaosbox">
...
<script>
    // 역할 선택(DB)
    $("#organizeId").val("${user.organizeId}").prop("selected", true);

    // 회사 선택(DB)
    $("#business").val(${user.business}).prop("selected", true);
