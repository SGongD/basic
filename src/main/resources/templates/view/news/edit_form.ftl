...
<div class="form-group">
    <label class="col-sm-4 control-label" for="title">제목
...
<div class="form-group">
    <label class="col-sm-4 control-label" for="description">내용
        <span class="text-danger">*</span>
    </label>
    <div class="col-sm-8">
...
<div class="form-group">
    <label class="col-sm-4 control-label" for="address">URL
        <span class="text-danger">*</span>
    </label>
    <div class="col-sm-8">
...
<div class="form-group">
    <label class="col-sm-4 control-label" for="newsTime">사건 발생 시간
        <span class="text-danger">*</span>
    </label>
    <div class="col-sm-8">
