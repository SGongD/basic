...
public class LocalIdGeneratorImpl implements LocalIdGenerator {
    ...
    private final ConcurrentHashMap<String, SnowflakeIdGenerator> idGeneratorMap = new ConcurrentHashMap<String, SnowflakeIdGenerator>();
    ...
    public String nextUniqueId(String startTimestamp, long dataCenterId, long machineId) throws Exception {
        return nextUniqueId(SIMPLE_DATE_FORMAT.parse(startTimestamp).getTime(), dataCenterId, machineId);
    }
    ...
    public String[] nextUniqueIds(String startTimestamp, long dataCenterId, long machineId, int count) throws Exception {
        return nextUniqueIds(SIMPLE_DATE_FORMAT.parse(startTimestamp).getTime(), dataCenterId, machineId, count);
    }
